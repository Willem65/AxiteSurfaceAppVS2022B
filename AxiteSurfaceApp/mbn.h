...
#define MBN_ENG_ADDR_TIMEOUT        4 /* seconds */
#define MBN_ENG_ADDR_MSG_TIMEOUT    1 /* sending address reservation information packets every second */
...
//-----------------------------------------------------------------------
// DIT WERKT WEL !!!
//MBN_EXPORT char mbnVersion(char *);
MBN_EXPORT char retString(char *); 
//__declspec(dllexport) int __stdcall mbnVersion(char *);
//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
//DIT WERKT NIET !!!!
...
//struct mbn_interface * mbnUDPOpen(char *, char *, char *, char *);  // Maak verbinding met ethernet
   


MBN_EXPORT void connectToObjects(int, int, int, int);
//MBN_EXPORT int mambaInit(int itf);
//MBN_EXPORT int start(int num);
MBN_EXPORT void sensor(unsigned short , int );
//MBN_EXPORT void UpdateActuator(unsigned short, int);
//MBN_EXPORT int ActuatorVal();
//MBN_EXPORT int ActuatorObj();
// MBN_EXPORT int ActuatorVal1();
// MBN_EXPORT int ActuatorObj1();
// MBN_EXPORT int ActuatorVal2();
// MBN_EXPORT int ActuatorObj2();




MBN_EXPORT void mSetActuatorData(struct mbn_handler *mbn, unsigned short, union mbn_data data);
MBN_EXPORT void mOnlineStatus(struct mbn_handler *mbn, unsigned long, char);

//MBN_EXPORT int get_data_c();
...
#endif
#ifdef MBN_IF_UNIX
struct mbn_interface * MBN_EXPORT mbnUnixOpen(char *, char *, char *);
#endif
